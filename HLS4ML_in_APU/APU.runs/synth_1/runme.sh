...
HD_PWD='C:/Users/Jiang/OneDrive/University of Washington/LAB/APU-Design/simpleAPUexample/APU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simpleAPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simpleAPU.tcl
