...
HD_PWD='C:/Users/Jiang/gep-fw/Projects/APU/APU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simpleAPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simpleAPU.tcl -notrace
